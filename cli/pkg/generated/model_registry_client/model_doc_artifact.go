...
func (o *DocArtifact) UnmarshalJSON(data []byte) (err error) {
	...
	varDocArtifact := _DocArtifact{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDocArtifact)

	if err != nil {
		return err
	}

	*o = DocArtifact(varDocArtifact)
