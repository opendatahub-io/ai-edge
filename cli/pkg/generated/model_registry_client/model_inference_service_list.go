...
func (o *InferenceServiceList) UnmarshalJSON(data []byte) (err error) {
	...
	varInferenceServiceList := _InferenceServiceList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInferenceServiceList)

	if err != nil {
		return err
	}

	*o = InferenceServiceList(varInferenceServiceList)
