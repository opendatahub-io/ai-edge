...
func (o *RegisteredModelList) UnmarshalJSON(data []byte) (err error) {
	...
	varRegisteredModelList := _RegisteredModelList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRegisteredModelList)

	if err != nil {
		return err
	}

	*o = RegisteredModelList(varRegisteredModelList)
