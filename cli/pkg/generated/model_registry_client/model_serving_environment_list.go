...
func (o *ServingEnvironmentList) UnmarshalJSON(data []byte) (err error) {
	...
	varServingEnvironmentList := _ServingEnvironmentList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varServingEnvironmentList)

	if err != nil {
		return err
	}

	*o = ServingEnvironmentList(varServingEnvironmentList)
