...
func (dst *MetadataValue) UnmarshalJSON(data []byte) error {
	...
	err = newStrictDecoder(data).Decode(&dst.MetadataBoolValue)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.MetadataDoubleValue)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.MetadataIntValue)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.MetadataProtoValue)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.MetadataStringValue)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.MetadataStructValue)
	if err == nil {
