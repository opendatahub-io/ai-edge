...
func (o *ModelVersionList) UnmarshalJSON(data []byte) (err error) {
	...
	varModelVersionList := _ModelVersionList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varModelVersionList)

	if err != nil {
		return err
	}

	*o = ModelVersionList(varModelVersionList)
