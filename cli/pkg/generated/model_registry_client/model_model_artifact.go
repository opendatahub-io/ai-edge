...
type _ModelArtifact ModelArtifact
...
func (o *ModelArtifact) UnmarshalJSON(data []byte) (err error) {
	...
	varModelArtifact := _ModelArtifact{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varModelArtifact)

	if err != nil {
		return err
	}

	*o = ModelArtifact(varModelArtifact)
