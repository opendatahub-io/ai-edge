...
func (o *ServeModelList) UnmarshalJSON(data []byte) (err error) {
	...
	varServeModelList := _ServeModelList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varServeModelList)

	if err != nil {
		return err
	}

	*o = ServeModelList(varServeModelList)
