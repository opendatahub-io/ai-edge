...
func (o *InferenceService) UnmarshalJSON(data []byte) (err error) {
	...
	varInferenceService := _InferenceService{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInferenceService)

	if err != nil {
		return err
	}

	*o = InferenceService(varInferenceService)
