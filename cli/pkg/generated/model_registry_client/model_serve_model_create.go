...
func (o *ServeModelCreate) UnmarshalJSON(data []byte) (err error) {
	...
	varServeModelCreate := _ServeModelCreate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varServeModelCreate)

	if err != nil {
		return err
	}

	*o = ServeModelCreate(varServeModelCreate)
